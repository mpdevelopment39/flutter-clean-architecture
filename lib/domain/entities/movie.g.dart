...
void _movieSerialize(
  ...
  writer.writeStringList(offsets[1], object.genreIds);
  ...
  writer.writeBool(offsets[9], object.video);
...
Movie _movieDeserialize(
  ...
  final object = Movie(
    ...
    genreIds: reader.readStringList(offsets[1]) ?? [],
    id: reader.readLong(offsets[2]),
    originalTitle: reader.readString(offsets[3]),
    overview: reader.readString(offsets[4]),
    popularity: reader.readDouble(offsets[5]),
    posterPath: reader.readString(offsets[6]),
    releaseDate: reader.readDateTime(offsets[7]),
    title: reader.readString(offsets[8]),
    video: reader.readBool(offsets[9]),
